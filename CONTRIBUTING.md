...
面向用户的说明放在 `README.md`、`README.en.md` 和 `docs/` 的公开入口中；产品研究、状态记录和审阅材料不应混进用户导航。UI 截图使用可公开的演示作品，桌面图统一为 1920×1080，移动端优先使用 390×844。更新界面后，重新检查截图中的正文、模型名称、地址和任务记录是否适合公开。
